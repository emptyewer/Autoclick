...
#
# Created: Sun Jun  7 12:32:17 2015
...
class Ui_Form(QtGui.QDialog):
    ...
    def setupUi(self, Form):
        ...
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), self.closeClicked)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "0 autoclick locations collected", None))
